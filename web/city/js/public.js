...
(function() {
	...
	$("body").delegate(".proCityQuery,.proCityQueryAll", "keyup",
	function(event) {
		...
		if (htmlArr == "" || htmlArr == null) {
			$("#dimCityQuery ul").html("<li class='none'>�Բ���,û���ҵ��ó���</li>");
			return false;
		} else {
...
function viewProvince(page) {
	...
	for (var i = start; i < end; i++) {
		...
		if (provinces[i].provinceName == '���ɹ�������') {
			p_name = '���ɹ�';
		} else if (provinces[i].provinceName == '����ʡ') {
			p_name = '����';
		} else {
...
function viewAllProvince(page) {
	...
	for (var i = start; i < end; i++) {
		...
		if (allProvinces[i].provinceName == '���ɹ�������') {
			p_name = '���ɹ�';
		} else if (allProvinces[i].provinceName == '����ʡ') {
			p_name = '����';
		} else {
