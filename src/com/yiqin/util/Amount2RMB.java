...
//
//		System.out.println(convert("1234,5678,9012.34").equals(
//				"壹仟贰佰叁拾肆亿伍仟陆佰柒拾捌万玖仟零壹拾贰元叁角肆分"));
//		System.out
//				.println(convert("1000,1000,1000.10").equals("壹仟亿零壹仟万零壹仟元壹角"));
//		System.out.println(convert("9009,9009,9009.99").equals(
//				"玖仟零玖亿玖仟零玖万玖仟零玖元玖角玖分"));
//		System.out.println(convert("5432,0001,0001.01").equals(
//				"伍仟肆佰叁拾贰亿零壹万零壹元零壹分"));
//		System.out.println(convert("1000,0000,1110.00").equals("壹仟亿零壹仟壹佰壹拾元整"));
//		System.out
//				.println(convert("1010,0000,0001.11").equals("壹仟零壹拾亿零壹元壹角壹分"));
//		System.out.println(convert("1000,0000,0000.01").equals("壹仟亿元零壹分"));

		System.out.println(convert("100000001110.00").equals("壹仟亿零壹仟壹佰壹拾元整"));
		System.out.println("肆仟叁佰贰拾壹元整".equals(convert("4321.00")));
		System.out.println(convert("123456789012.34").equals(
				"壹仟贰佰叁拾肆亿伍仟陆佰柒拾捌万玖仟零壹拾贰元叁角肆分"));
	}
}
